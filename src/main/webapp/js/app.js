var trafficApp = angular.module('exampleApp', ['ui.router', 'ngCookies','trafficApp.services','ui.bootstrap','ui.utils'])
...
trafficApp.run(function ($rootScope, $location, $cookieStore, UserService) {
    ...
    $location.path("/login");
    var acctoken = $location.search();
    var token = acctoken.ps;
